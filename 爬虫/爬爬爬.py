...
for role in roles:
    ...
    # 针对不同角色自定义备选关键词（已添加多语言支持）
    if role == "丛雨":
        suffixes = [
            "立绘", "壁纸", "千恋万花",
            "ムラサメ", "Murasame", "Senren Banka", "千恋＊万花",
            "game character", "anime girl", "murasame character"
        ]
    elif role == "Neuro-sama":
        suffixes = [
            "vtuber", "art", "fanart", "character",
            "ニューロサマ", "Neuro sama", "Neurochan",
            "AI vtuber", "Neurosama", "vtuber illustration"
        ]
    elif role == "永雏塔菲":
        suffixes = [
            "虚拟主播", "立绘", "壁纸", "Taffy",
            "永雏塔菲", "Ace Taffy", "Taffy vtuber",
            "エースタフィー", "Taffy chan", "vtuber Taffy",
            "Ace Taffy fanart", "Taffy illustration"
        ]
    elif role == "东雪莲":
        suffixes = [
            "虚拟主播", "立绘", "壁纸",
            "東雪蓮", "Azuma Yukiren", "Snow Lotus",
            "アズマユキレン", "Yukiren", "Snow Lotus art"
        ]
    elif role == "ShikiNatsume":
        suffixes = [
            "立绘", "壁纸", "Shiki Natsume",
            "棗シキ", "Shiki Natsume art", "Natsume Shiki",
            "character Shiki", "anime Shiki", "Shiki illustration"
        ]
    elif role == "棍母":
        suffixes = [
            "棍子", "棍娘", "Gun Mu",
            "gun mu art", "棍母 character", "棍娘 vtuber",
            "gun stick girl", "gun character"
        ]
    elif role == "otto":
        suffixes = [
            "otto", "吉吉国王", "电棍",
            "otto lol", "otto streamer", "电棍 otto",
            "吉吉国王 otto", "otto fanart", "오토", "オット"
        ]
    elif role == "Ayachi_Nene":
        suffixes = [
            "立绘", "壁纸", "Ayachi Nene", "宁宁",
            "綾地寧々", "Ayachi Nene art", "Nene Ayachi",
            "綾地寧々 壁紙", "Nene fanart", "Nene illustration"
        ]
    else:
        suffixes = ["立绘", "壁纸", "art", "vtuber", "fanart", "illustration"]
